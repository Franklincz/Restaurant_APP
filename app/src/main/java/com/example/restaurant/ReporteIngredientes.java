...
public class ReporteIngredientes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAtras = findViewById(R.id.btnAtrasReporteIngredientes);
        lista = new ArrayList<>();
        ...
        btnAgregar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), AgregarIngrediente.class);
        ...
        btnAtras.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), Main_Administrator.class);
    ...
    protected void onStart(){
        ...
        BDReferencia.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                lvIngredientes.setAdapter((ListAdapter) ingredientesAdapter);
            }
    ...
    private void showDialogUpdate(Activity activity, int position){
        ...
        final EditText txtActualizaIngrediente = dialog.findViewById(R.id.txtActualizaIngrediente);
        final EditText txtActualizarCantidad = dialog.findViewById(R.id.txtActualizaCantidad);
    ...
    private boolean actualizarIngrediente(String id, String nombre, int cantidad) {
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference(FirebaseReference.INGREDIENTES_REFERENCE).child(id);
