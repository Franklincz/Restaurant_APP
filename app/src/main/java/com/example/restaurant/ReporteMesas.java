...
public class ReporteMesas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BDReferencia = FirebaseDatabase.getInstance().getReference(FirebaseReference.MESAS_REFERENCE);
        btnAgregar = findViewById(R.id.btnAgregarMesa);
        btnAtras = findViewById(R.id.btnAtrasReporteMesas);
        ...
        btnAtras.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ReporteMesas.this, Menu_employees.class));
