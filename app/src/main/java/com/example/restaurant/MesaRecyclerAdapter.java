...
public class MesaRecyclerAdapter extends RecyclerView.Adapter<MesaViewHolder> {
    ...
    public MesaRecyclerAdapter(List<Mesa> list) {
        this.list = list;
    }

    public MesaRecyclerAdapter() {
    ...
    public void onBindViewHolder(@NonNull final MesaViewHolder holder, final int position) {
        ...
        if (mesa.getEstado().equals("Disponible")) {
            holder.getImgMes().setImageResource(R.drawable.ic_mesadisponible);
        } else if (mesa.getEstado().equals("Reservada")) {
            holder.getImgMes().setImageResource(R.drawable.ic_mesareservadaa);
        } else {
            holder.getImgMes().setImageResource(R.drawable.ic_mesaocupada);
        }
